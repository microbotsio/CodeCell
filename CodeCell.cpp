...
void CodeCell::Init(uint16_t sense_motion) {
  ...
  if (wakeup_reason == ESP_SLEEP_WAKEUP_GPIO) {
    ...
    Serial.println(" ");
    Serial.print("Hello World! I am your CodeCell ~ ");
  }
  Serial.println("Please wait while I setup my sensors..");
  ...
  Serial.println("Sensors configuration is complete ~ Printing Sensors Readings..");
  delay(80);
  PrintSensors();

  Run(); /*Check Charging Status*/
